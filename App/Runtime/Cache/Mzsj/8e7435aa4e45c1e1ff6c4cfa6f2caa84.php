...
<body>
	...
	<table class="table-form">
		<tr class="tr-header">
			...
			<th width="350">openid</th>
			<th width="60">性别</th>
			<th>关注时间</th>
		</tr>
		<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wxuser): $mod = ($i % 2 );++$i;?><tr>
			<td><?php echo ($wxuser["userid"]); ?></td>
			<td><?php echo ($wxuser["wxnick"]); ?></td>
			<td><?php echo ($wxuser["openid"]); ?></td>
			<td><?php if($wxuser[wxxb] == 1): ?><span class="color_green">男</span><?php endif; if($wxuser[wxxb] == 2): ?><span class="color_red">女</span><?php endif; ?></td>
			<td><?php echo (date("Y-m-d H:i:s",$wxuser["gztime"])); ?></td>
