...
<body>
	...
	<form action="<?php echo U();?>" class="form-box" method="post">
		<input type="hidden" value="<?php echo ($info["posid"]); ?>" name="posid" />
		<div class="form-group">
			<label for="name" class="item-label">推荐位名称：<span class="color_9"> 必须填写</span></label>
			<input type="text" name="name" value="<?php echo ($info["name"]); ?>" class="input-text">
		</div>
		<div class="form-group">
